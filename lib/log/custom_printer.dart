...
class CustomPrinter extends LogPrinter {
  ...
  static final levelColors = {
    ...
    Level.debug: const AnsiColor.fg(250),
    Level.info: const AnsiColor.fg(12),
    Level.warning: const AnsiColor.fg(208),
    Level.error: const AnsiColor.fg(196),
    Level.fatal: const AnsiColor.fg(35),
  };
  ...
  AnsiColor _getErrorColor(Level level) {
    if (colors && !LocalPlatform.isIOS) {
      if (level == Level.fatal) {
        return levelColors[Level.fatal]!;
      } else {
    ...
    for (var line in message.split('\n')) {
      if (level.index <= Level.error.index) {
        while (line.length > lineLength) {
          String subLine = line.substring(0, lineLength);
          buffer.add(color('$verticalLineAtLevel$emoji$subLine'));
          line = line.substring(lineLength, line.length);
        }
      }
